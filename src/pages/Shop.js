                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-12 col-md-6 col-sm-6 mb-5" >
                                    <div class="product">
                                        <div class="product-wrap">
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/322.jpg" alt="product-img" /></a>
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-second" src="assets/images/444.jpg" alt="product-img" /></a>
                                        </div>
                                        ...
                                        <div class="product-info">
                                            <h2 class="product-title h5 mb-0"><a href="/single-product">Floral Kirby</a></h2>
                                            <span class="price">
                                                $329.10
                                            </span>
                                        </div>
                                ...
                                <div class="col-lg-4 col-12 col-md-6 col-sm-6 mb-5">
                                    <div class="product">
                                        <div class="product-wrap">
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/111.jpg" alt="product-img" /></a>
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-second" src="assets/images/444.jpg" alt="product-img" /></a>
                                        </div>
                                        ...
                                        <div class="product-info">
                                            <h2 class="product-title h5 mb-0"><a href="/single-product">Open knit switer</a></h2>
                                            <span class="price">
                                                $29.10
                                            </span>
                                        </div>
                                ...
                                <div class="col-lg-4 col-12 col-md-6 col-sm-6 mb-5" >
                                    <div class="product">
                                        <div class="product-wrap">
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/222.jpg" alt="product-img" /></a>
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-second" src="assets/images/322.jpg" alt="product-img" /></a>
                                        </div>
                                        ...
                                        <div class="product-info">
                                            <h2 class="product-title h5 mb-0"><a href="/single-product">Official trendy</a></h2>
                                            <span class="price">
                                                $350.00 – $355.00
                                            </span>
                                        </div>
                                ...
                                <div class="col-lg-4 col-12 col-md-6 col-sm-6 mb-5">
                                    <div class="product">
                                        <div class="product-wrap">
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/322.jpg" alt="product-img" /></a>
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-second" src="assets/images/111.jpg" alt="product-img" /></a>
                                        </div>
                                        ...
                                        <div class="product-info">
                                            <h2 class="product-title h5 mb-0"><a href="/single-product">Frock short</a></h2>
                                            <span class="price">
                                                $249
                                            </span>
                                        </div>
                                ...
                                <div class="col-lg-4 col-12 col-md-6 col-sm-6 mb-5">
                                    <div class="product">
                                        <div class="product-wrap">
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-first" src="assets/images/444.jpg" alt="product-img" /></a>
                                            <a href="/single-product"><img class="img-fluid w-100 mb-3 img-second" src="assets/images/222.jpg" alt="product-img" /></a>
                                        </div>
                                        ...
                                        <div class="product-info">
                                            <h2 class="product-title h5 mb-0"><a href="/single-product">Sleeve dress</a></h2>
                                            <span class="price">
                                                $59.10
                                            </span>
                                        </div>
                                ...
                                <div class="col-lg-4 col-12 col-md-6 col-sm-6 mb-5" >
                                    <div class="product">
                                        ...
                                        <div class="product-info">
                                            <h2 class="product-title h5 mb-0"><a href="/single-product">Stylish dress</a></h2>
                                            <span class="price">
                                                $99.00
                                            </span>
                                        </div>
