...
function Header() {
    return (
        <nav class="navbar navbar-expand-lg navbar-light bg-white w-100 navigation" id="navbar">
            <div class="container">
                <Link class="navbar-brand font-weight-bold" to={{ pathname: "/" }}>GoBazary</Link>
                ...
                <div class="collapse navbar-collapse " id="main-navbar">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item active">
                            <Link class="nav-link" to={{ pathname: "/apiTest" }}>ApiTest</Link>
                        </li>
                        ...
                        <li class="nav-item active">
                            <Link class="nav-link" to={{ pathname: "/cart" }}>Panier</Link>
                        </li>
                ...
                <ul class="top-menu list-inline mb-0 d-none d-lg-block" id="top-menu">
                    ...
                    <li class="dropdown nav-item dropdown-slide list-inline-item">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown5" role="button" data-delay="350"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown5">
                            ...
                            <li><Link to={{ pathname: "/signup" }}>SignUp Page</Link></li>
                            <li><Link to={{ pathname: "/forgot-password" }}>Forgot Password</Link></li>
                            <li><Link to={{ pathname: "/" }}>Voir profil</Link></li>
                            <li><Link to={{ pathname: "/" }}>Se déconnecter</Link></li>
